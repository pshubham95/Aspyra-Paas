...
success: function(response) {
  ...
  document.getElementById('apache_ip').innerHTML = 'http://'+ip+':'+response['port']['port2'];
  document.getElementById('apache_ip_a').href = 'http://'+ip+':'+response['port']['port2'];

  document.getElementById('admin_ip').innerHTML = 'http://'+ip+':'+response['port']['port2']+'/phpmyadmin/';
  document.getElementById('admin_ip_a').href = 'http://'+ip+':'+response['port']['port2']+'/phpmyadmin/';
